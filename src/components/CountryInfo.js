...
const CountryInfo = ({country, back}) => {
    ...
    return(
        <div className='br1'> 
            <div className='flex flex-column o-72 h-100 w-100 br2 ma1 pa3 shadow-hover focus-outline'> 
            ...
            <div className='flex flex-column flex-row-l ma2 pa4 vh-100 br2 shadow-hover focus-outline'>
